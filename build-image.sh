...
# Set this to default to a KNOWN GOOD pi firmware (e.g. 1.20200902); this is used if RASPBERRY_PI_FIRMWARE env variable is not specified
DEFAULT_GOOD_PI_VERSION="1.20200902"
